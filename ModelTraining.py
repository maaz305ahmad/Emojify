...
recognition_model.add(Conv2D(32, kernel_size=(
...
# Compile Model
recognition_model.compile(loss='categorical_crossentropy', optimizer=Adam(
...
while True:
    ...
    for (x, y, w, h) in num_faces:
        ...
        cv2.putText(frame, facial_dict[maxindex], (x+20, y-60),
